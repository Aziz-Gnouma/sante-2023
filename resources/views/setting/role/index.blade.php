          ...
          <br><br>
            <div class="container mx-auto px-6 py-2">
                <div class="text-right">
                  @can('Role create')
                    <a style="background-color: blue; color: black;" href="{{route('admin.roles.create')}}" class="bg-blue-500 text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">New Role</a>
                </div>
                @endcan
                  ...
                  <tbody>
                    @can('Role access')
                      ...
                      <tr class="hover:bg-grey-lighter">
                        <td  class="py-4 px-6 border-b border-grey-light"> <div style=" font-weight: bold;">{{ $role->name }}</div></td>
                        ...
                        <td class="py-4 px-6 border-db border-grey-light text-right">

                          @can('Role edit')
                          <a  style="background-color: blue; color: white;" href="{{route('admin.roles.edit',$role->id)}}" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-blue-400">Edit</a>
                          @endcan
